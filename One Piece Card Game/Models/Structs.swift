...
[AllCharachter(id: 1, picture: UIImage(named: "babyLuffy")!, rarity: .common, description: "luffy"),
 AllCharachter(id: 2, picture: UIImage(named: "babyZoro")!, rarity: .common, description: "zoro"),
 AllCharachter(id: 3, picture: UIImage(named: "babyCoby")!, rarity: .common, description: "coby"),
 AllCharachter(id: 4, picture: UIImage(named: "babyUsopp")!, rarity: .common, description: "usopp"),
 AllCharachter(id: 5, picture: UIImage(named: "alvida")!, rarity: .common, description: "alvida"),
 AllCharachter(id: 6, picture: UIImage(named: "buggy")!, rarity: .common, description: "buggy"),
 AllCharachter(id: 7, picture: UIImage(named: "helmeppo")!, rarity: .common, description: "helmepo"),
 AllCharachter(id: 8, picture: UIImage(named: "morgan")!, rarity: .common, description: "morgan"),
 AllCharachter(id: 9, picture: UIImage(named: "nami1ep")!, rarity: .common, description: "nami")].shuffled()
